(function ($) {
    $.fn.epicZoom = function (m) {
        var n = $('body');
        var o = {isInBounds: function (a, b, c, d) {
        ...
        var p = {'size': 150, 'border': '1px solid white', 'largeImage': '', 'magnification': 1.0, 'hideCursor': true, 'blankCursor': './js/blank.png', 'debug': false};
        m = $.extend(p, m);
        ...
        return this.each(function () {
            ...
            l.load(function () {
                ...
                var d = $('.eiz-magnifier', c).css('position', 'absolute').css('margin', 0).css('padding', 0).css('border', m.border).css('-moz-box-shadow', '0 0 5px #777, 0 0 10px #aaa inset').css('-webkit-box-shadow', '0 0 5px #777').css('box-shadow', '0 0 5px #777, 0 0 10px #aaa inset').css('overflow', 'hidden').css('z-index', 20).css('width', m.size + 'px').css('height', m.size + 'px');
                ...
                var h = {left: k.offset().left, top: k.offset().top};
                var i = {width: k.width(), height: k.height()};
                var j = {top: parseInt(k.css('padding-top'), 10), right: parseInt(k.css('padding-right'), 10), bottom: parseInt(k.css('padding-bottom'), 10), left: parseInt(k.css('padding-left'), 10)};
                d.hide();
                $(window).resize(function () {
                    h = {left: k.offset().left, top: k.offset().top};
                    i = {width: k.width(), height: k.height()};
                    if ( o.isDebug() ) {
